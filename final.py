...
def query_database():
	...
	c.execute("SELECT rowid, * FROM character")
	records = c.fetchall()
...
def search_records():
	...
	c.execute("SELECT rowid, * FROM character WHERE name like ?", (lookup_record,))
	records = c.fetchall()
...
# Define Our Columns
my_tree['columns'] = ("ID", "Last Name", "ID", "Address", "City", "State", "Zipcode")
...
code_name_label = Label(data_frame, text="Code Name")
code_name_label.grid(row=0, column=4, padx=10, pady=10)
code_name_entry = Entry(data_frame)
code_name_entry.grid(row=0, column=5, padx=10, pady=10)

occupation_label = Label(data_frame, text="Occupation")
occupation_label.grid(row=1, column=0, padx=10, pady=10)
occupation_entry = Entry(data_frame)
occupation_entry.grid(row=1, column=1, padx=10, pady=10)
...
sex_label = Label(data_frame, text="Sex")
sex_label.grid(row=1, column=4, padx=10, pady=10)
sex_entry = Entry(data_frame)
sex_entry.grid(row=1, column=5, padx=10, pady=10)

residence_label = Label(data_frame, text="Residence")
residence_label.grid(row=1, column=6, padx=10, pady=10)
residence_entry = Entry(data_frame)
residence_entry.grid(row=1, column=7, padx=10, pady=10)

birthplace_label = Label(data_frame, text="Birthplace")
birthplace_label.grid(row=1, column=6, padx=10, pady=10)
birthplace_entry = Entry(data_frame)
birthplace_entry.grid(row=1, column=7, padx=10, pady=10)
